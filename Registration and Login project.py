...
root = Tk()
root.title("--- Registration and Login system using Python ---")
...
def LoginForm():
    ...
    lbl_username = Label(LoginFrame, text="Username:", font=('arial', 22), bd=18)
    lbl_username.grid(row=1)
    lbl_password = Label(LoginFrame, text="Password:", font=('arial', 22), bd=18)
    ...
    lbl_register = Label(LoginFrame, text="Register", fg="Blue", font=('arial', 18))
...
def RegisterForm():
    ...
    lbl_username = Label(RegisterFrame, text="Username:", font=('arial', 22), bd=18)
    lbl_username.grid(row=1)
    lbl_password = Label(RegisterFrame, text="Password:", font=('arial', 22), bd=18)
    lbl_password.grid(row=2)
    ...
    lbl_login = Label(RegisterFrame, text="Login", fg="Blue", font=('arial', 18))
...
def Register():
    ...
    if USERNAME.get == "" or PASSWORD.get() == "":
        ...
        if cursor.fetchone() is not None:
            lbl_result2.config(text="Username is already registered", fg="red")
        else:
